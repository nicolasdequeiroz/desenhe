...
/**
 * desenhe theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { desenheTheme } from './desenhe';
 *   import './desenhe.css';
 */
export const desenheTheme = {
  name: 'desenhe',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "Manrope, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif",
    "--font-family-heading": "\"Courier Prime\", \"Courier New\", Courier, monospace",
    ...
    "--color-background-surface": "light-dark(#FFFFFF, #282219)",
    "--color-background-body": "light-dark(#FAF7F3, #171310)",
    "--color-background-card": "light-dark(#FFFFFF, #1D1813)",
    "--color-background-popover": "light-dark(#FFFFFF, #1D1813)",
    "--color-background-muted": "light-dark(#F2EDE6, #1D1813)",
    "--color-accent": "light-dark(#BC5B00, #F67800)",
    "--color-accent-muted": "light-dark(#9E430033, #FFB68340)",
    ...
    "--color-text-primary": "light-dark(#231A13, #EEE0D7)",
    "--color-text-secondary": "light-dark(#53443A, #BBA79C)",
    "--color-text-disabled": "light-dark(#A08D82, #6C5B51)",
    "--color-text-accent": "light-dark(#812A00, #FFB683)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#FFFFFF, #651100)",
    "--color-on-success": "light-dark(#ffffff, #171717)",
    "--color-on-error": "light-dark(#ffffff, #171717)",
    "--color-on-warning": "#171717",
    "--color-icon-accent": "light-dark(#9E4300, #FFB683)",
    "--color-icon-primary": "light-dark(#231A13, #EEE0D7)",
    "--color-icon-secondary": "light-dark(#53443A, #BBA79C)",
    "--color-icon-disabled": "light-dark(#A08D82, #6C5B51)",
    ...
    "--color-border": "light-dark(#231A131A, #FDEEE51A)",
    "--color-border-emphasized": "light-dark(#BBA79C, #53443A)",
    ...
    "--color-background-inverted": "light-dark(#231A13, #FFFBF7)",
